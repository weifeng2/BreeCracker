//主要是搞定su和sp两个参数，其他参数在https://login.sina.com.cn/sso/prelogin.php返回中存在

//下面开始整su参数,搜素su =很容易找到代码
...
var username = '15088883333@sina.com';
var su = sinaSSOEncoder.base64.encode(urlencode(username));
console.log(su);

//下面三个参数在在https://login.sina.com.cn/sso/prelogin.php返回中存在
var publicKey = '';
var servertime = 1629081093;
var nonce = 'X54K8N';

var password = '111222333';
